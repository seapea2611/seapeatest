 ...
 * @author seape
 */
public class dat_ve_jurrasic extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thời gian chiếu phim: 9:20");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dat_ve_jurrasic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
